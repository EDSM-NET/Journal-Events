...
class SAAScanComplete extends Event
{
    ...
    public static function run($json)
    {
        ...
        // Insert discoverers
        $systemsBodiesDiscoverersModel = new \Models_Systems_Bodies_Discoverers;

        try
        {
            $insert                         = array();
            $insert['refBody']              = $currentBody;
            $insert['discoverers']          = \Zend_Json::encode($json['Discoverers']);

            $systemsBodiesDiscoverersModel->insert($insert);
        ...
        unset($systemsBodiesDiscoverersModel);

        // Insert mappers
        $systemsBodiesMappersModel = new \Models_Systems_Bodies_Mappers;

        try
        {
            $insert                         = array();
            $insert['refBody']              = $currentBody;
            $insert['mappers']              = \Zend_Json::encode($json['Mappers']);

            $systemsBodiesMappersModel->insert($insert);
        ...
        unset($systemsBodiesMappersModel);
